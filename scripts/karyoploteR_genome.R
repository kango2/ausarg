...
pdf("/g/data/xl04/ka6418/bassiana/publication-v2/eval/genomeplot/curV1/yahs.pdf", width = 11, height = 8.5, pointsize = 12)
#dev.off()
...
kpAddBaseNumbers(kp)
##plot telomeres
kpPlotRegions(kp, data=cengr_CEN187, col="#FF6961", r0=-0.1, r1=-0.35,clipping = TRUE,avoid.overlapping=FALSE)
kpPlotRegions(kp, data=cengr_CEN199, col="#966FD6", r0=-0.1, r1=-0.35,clipping = TRUE,avoid.overlapping=FALSE)
