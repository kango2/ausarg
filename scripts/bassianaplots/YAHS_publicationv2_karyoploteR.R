...
mygenome <- read_delim("/g/data/xl04/genomeprojects/Pogona_vitticeps/analysis/seqtables/POGVITdef.h1.corrected_YAHS_seqtable.csv", delim = ",") 
...
pdf("/g/data/xl04/ka6418/bassiana/publication-v2/eval/genomeplot/yahs/yahs.pdf", width = 11, height = 8.5, pointsize = 12)
#dev.off()
