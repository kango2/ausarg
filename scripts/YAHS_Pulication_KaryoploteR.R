...
pdf("/g/data/xl04/ka6418/bassiana/publication-v2/eval/genomeplot/yahs/yahs.pdf", width = 7, height = 5, pointsize = 12)
#dev.off()
...
kpPlotRegions(kp, data=cengr_CEN199, col="#C3B1E1", r0=-0.1, r1=-0.25,clipping = TRUE,avoid.overlapping=FALSE)
