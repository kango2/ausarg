...
mygenome <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/seqtable/BASDU_SUP_DEEP_hifiasm_yahs_curv1_seqtable.csv", delim = ",") 
...
telomeresdf <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/telomeres/BASDU_SUP_DEEP_hifiasm_yahs_curv1_Telomeres.csv", delim = ",") 
...
cendf <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/centromere/curv1/run1/Summary.of.repetitive.regions.BASDU_SUP_DEEP_hifiasm_yahs_curv1.fasta.csv", delim = ",") 
...
ilmnrd <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/depth/curv1/BASDU_curv1.merged.illum.10000.depth.bed", delim = " ",col_names = column_names)
...
column_names <- c("Chromosome", "Start", "End", "AverageDepth")
ontrd <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/depth/curv1/BASDU_curv1.merged.ont.10000.depth.bed", delim = " ",col_names = column_names)
...
hifird <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/depth/curv1/BASDU_curv1.merged.pb.10000.depth.bed", delim = " ",col_names = column_names)
...
gc <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/gc/BASDU_SUP_DEEP_hifiasm_yahs_curv1.fasta_GC.csv", delim = ",") 
...
Nregions <- read_delim("/g/data/xl04/ka6418/bassiana/publication-v2/eval/gaps/BASDU_SUP_DEEP_hifiasm_yahs_curv1_Nregions.csv",delim = ",", col_names = column_names)
Nregions_gr <- toGRanges(data.frame(Nregions) %>% select(chr = chromosome, start = start, end = end) )

pdf("/g/data/xl04/ka6418/bassiana/publication-v2/eval/genomeplot/curV1/yahs.pdf", width = 9, height = 5, pointsize = 12)
#dev.off()
...
kp <- plotKaryotype(genome = mygenomegr,plot.params = pp,chromosome="BASDUscf10.2")
...
kpAddLabels(kp, labels="Illumina", r0=0.0, r1=0.15, data.panel = 1,cex=0.5,label.margin=0.003,side="right")
...
kpAddLabels(kp, labels="HiFi", r0=0.50, r1=0.65, data.panel = 1,cex=0.5,label.margin=0.003,side="right")
