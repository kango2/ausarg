...
/g/data/xl04/ka6418/HiC_Assembly_Experiement/juicer/scripts/juicer.sh -D $path_juicer -d ${WORK_DIR} -y ${WORK_DIR}/base_Arima.txt -t 48  -g base -s Arima -z base.fa -p base.sizes >juicer.log.o 2>juicer.log.e
wait
