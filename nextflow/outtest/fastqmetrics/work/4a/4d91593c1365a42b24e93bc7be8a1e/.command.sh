...
def main():
    ...
    fastq_file = os.path.join(os.getcwd(), 'testhifi.fq.gz')
    output = os.path.join(os.getcwd(), 'fastqmetrics')
    process_fastq(fastq_file, output, 'PAF987', 'PACBIO_SMRT', 'BASDU', log_file)
