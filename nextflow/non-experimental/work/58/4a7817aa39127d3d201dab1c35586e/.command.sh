...
def main():
    file_prefix = f"TILRUW_PAF987_PACBIO_SMRT"
    log_file = os.path.join('longread_qc', f"{file_prefix}_processing_log.txt")
    process_fastq('testhifi.fq.gz', 'longread_qc', 'PAF987', 'PACBIO_SMRT', 'TILRUW', log_file)
