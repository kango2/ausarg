#!/bin/bash -ue
echo HIC_R1.fastq.gz HIC_R2.fastq.gz PE_1.fq.gz PE_2.fq.gz >> /g/data/xl04/ka6418/github/ausarg/nextflow/non-experimental/test.txt



joined_files=""

for file in HIC_R1.fastq.gz HIC_R2.fastq.gz PE_1.fq.gz PE_2.fq.gz; do
