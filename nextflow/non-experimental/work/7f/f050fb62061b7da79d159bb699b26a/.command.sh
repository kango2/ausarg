...
if ["ILLUMINA" = "ILLUMINA"]; then 
    ...
    echo /g/data/xl04/ka6418/github/ausarg/nextflow/kmer_nf.sh -i PE_1.fq.gz -s BASDU -o /g/data/xl04/ka6418/github/ausarg/nextflow/outtest -l 17 -t ILLUMINA >> /g/data/xl04/ka6418/github/ausarg/nextflow/non-experimental/test.txt
