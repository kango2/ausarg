...
def main():
    ...
    metrics = []
    fastq_files = ['test_illum_R1_val_1.fq.gz','test_illum_R2_val_2.fq.gz']
    ...
    with open(os.path.join('shortread_qc', f"{'BASDU'}_{'maf758'}_{'ILLUMINA'}.csv"), 'w', newline='') as csvfile:
